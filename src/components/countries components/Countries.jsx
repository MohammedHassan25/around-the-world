  ...
  return (
    <>
      {props.filteredCountries.length === 0 && props.input.current?.value ? (
        <NotFoundComponent
          className={"flex flex-col items-center justify-center p-2 text-center dark:bg-gray-900 dark:text-gray-100 md:pt-4"}
          h1={"No results found"}
          error={"We can’t find the country you searched for..."}
          hint={"Try to search for another one"}
          svg={
            <svg
              style={{
                maxWidth: "416px",
            ...
            >
              ...
              <path
                ...
                className="stroke-[#8A8A8A] dark:stroke-gray-100"
                stroke-width="7"
              />
              <path
                className="stroke-[#8A8A8A] dark:stroke-gray-100"
              ...
              <path
                ...
                className="fill-[#8A8A8A] dark:fill-gray-700"
              />
              <path
